 ...
 */
func myList(band: String, number: Int) {
    print("My #\(number) favorite band is \(band).")
}

myList("Grimes", number: 4)
...
madLib("Boomer", noun: "Canada", preposition: "from")
 ...
 */
func nameGame(name: String) -> String {
    return "To infinity and beyond \(name)!"
}

nameGame("Max".uppercaseString)
